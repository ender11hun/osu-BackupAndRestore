...
namespace EnderCode.Utils
{
    public static class UPnP
    {
        ...
        {
            InternalIP = GetInternalIPAddresses()[0];
        ...
        public static void ForwardPort(int port, ProtocolType protocol, string description)
        {
            ...
            XmlDocument xdoc = SOAPRequest(_serviceUrl, "<u:AddPortMapping xmlns:u=\"urn:schemas-upnp-org:service:WANIPConnection:1\">" +
                ...
                "<NewInternalPort>" + port.ToString() + "</NewInternalPort><NewInternalClient>" + InternalIP.ToString() +
        ...
        public static IPAddress[] GetInternalIPAddresses()
        {
            IPAddress[] addresses = Dns.GetHostAddresses(Dns.GetHostName());
            addresses = addresses.Where(x => x.ToString().Split('.').Length == 4).ToArray();
            return addresses;
        }
